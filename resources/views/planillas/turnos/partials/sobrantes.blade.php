<x-erp-card title="SOBRANTES Y FALTANTES">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-sm" style="background-color: #f7f2e7; border-color: #b8a18f;">
            <thead>
                <tr style="background-color: #e5d1bd;">
                    <th colspan="2" class="text-center">FALTANTES O SOBRANTES</th>
                </tr>
            </thead>
            <tbody>
                <tr>
    ...
    <div class="row g-2 mt-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control form-control-sm" name="revisado" id="revisado" />
        </div>
    </div>
