...
@section('title', 'Inventarios ACPM')

@section('content')
    <div class="pastel-section mb-3">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
            <div>
                <h4 class="mb-0 text-success fw-bold">INVENTARIOS ACPM</h4>
                <small class="text-muted">Formato de control por planilla con kardex de costo promedio y ventas.</small>
            </div>
            <button type="submit" form="inventario-acpm-form" class="btn btn-primary btn-sm">Guardar inventario</button>
        </div>
    </div>
    ...
    <form id="inventario-acpm-form" method="POST" action="{{ route('inventarios-acpm.store') }}">
        @csrf
        ...
        <x-erp-card title="INVENTARIOS ACPM">
            <div class="table-responsive">
                <table class="table table-bordered table-sm mb-0 align-middle" id="inventario-acpm-table">
                    <thead>
                        <tr style="background-color:#000; color:#00c26a; letter-spacing:.25rem; font-weight:800;">
                            <th colspan="14" class="text-center fs-5">INVENTARIOS&nbsp;&nbsp;&nbsp;&nbsp;ACPM</th>
                        </tr>
                        <tr style="background-color:#c8e6c9;">
                            <th colspan="2" class="text-center align-middle">PLANILLA</th>
                            <th colspan="5" class="text-center align-middle">GALONES</th>
                    ...
                    <tbody id="inventario-acpm-body">
                        ...
                        @foreach ($rows as $index => $row)
                            <tr data-index="{{ $index }}">
                                ...
                                <td>
                                    <input type="text"
                                        class="form-control form-control-sm text-end saldo-galones-output" readonly>
                                </td>
                                <td>
            ...
            <div class="p-3 d-flex justify-content-end">
                <button type="button" id="add-inventario-acpm-row" class="btn btn-sm btn-outline-primary">+ Agregar
                    fila</button>
            </div>
        </x-erp-card>
    </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const tbody = document.getElementById('inventario-acpm-body');
            const addBtn = document.getElementById('add-inventario-acpm-row');
