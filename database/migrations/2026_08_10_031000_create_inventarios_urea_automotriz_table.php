...
return new class extends Migration {
    ...
    {
        Schema::create('inventarios_urea_automotriz', function (Blueprint $table) {
            $table->id();
            $table->string('producto', 120)->default('UREA AUTOMOTRIZ');
    ...
    {
        Schema::dropIfExists('inventarios_urea_automotriz');
    }
};
