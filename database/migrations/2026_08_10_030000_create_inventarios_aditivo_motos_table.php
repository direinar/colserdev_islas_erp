...
return new class extends Migration {
    ...
    {
        Schema::create('inventarios_aditivo_motos', function (Blueprint $table) {
            $table->id();
            $table->string('producto', 120)->default('ADITIVO MOTOS');
    ...
    {
        Schema::dropIfExists('inventarios_aditivo_motos');
    }
};
